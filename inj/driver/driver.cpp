...
#define DVR_DEVICE_FILE xor_w(L"\\\\.\\EIQDV") // EIQDV is the original
...
NTSTATUS c_driver::write_memory_ex(PVOID base, PVOID buffer, DWORD size) // payson1337
{
	copy_memory req = { 0 };
...
PVOID c_driver::alloc_memory_ex(DWORD size, DWORD protect) // payson1337
{
